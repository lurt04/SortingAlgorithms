...
def CreateLists():
    ...
    unsortedList = []
    unsortedNumbers = open("C:\\Programming\\algoritmes\\InputFiles\\randomSorted.txt", "r")
    ...
    rSortedList = []
    rSorted = open("C:\\Programming\\algoritmes\\InputFiles\\reverseSorted.txt", "r")
    ...
    nearlySortedList = []
    nearlySorted = open("C:\\Programming\\algoritmes\\InputFiles\\nearlySorted.txt", "r")

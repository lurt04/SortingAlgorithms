...
void nearlySorted(unsigned short int *Numbers, unsigned short int i){
    ...
    std::ofstream File;
    std::string nearlySortedFile = "C:\\Programming\\algoritmes\\InputFiles\\nearlySorted.txt"; // verander dit naar het pad waarin uw file staat
...
void reverseSorted(unsigned short int *Numbers, unsigned short int i){
    ...
    std::ofstream File;
    std::string reverseSortedFile = "C:\\Programming\\algoritmes\\InputFiles\\reverseSorted.txt"; // verander dit naar het pad waarin uw file staat
...
void randomSorted(unsigned short int *Numbers, unsigned short int i){
    ...
    std::ofstream File;
    std::string randomSortedFile = "C:\\Programming\\algoritmes\\InputFiles\\randomSorted.txt"; // verander dit naar het pad waarin uw file staat
